        ...
        <form role="form" action="/admin/products/create" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="vlheight" name="vlheight" step="0.001" placeholder="0.000">
            </div>
            <div class="form-group">
              <label for="vllength">Comprimento</label>
              <input type="number" class="form-control" id="vllength" name="vllength" step="0.001" placeholder="0.000">
            </div>
            <div class="form-group">
